...
rigt click on index.html file .
goto copy path option and click on it.
after copy paste on browser.
2.taking "readme.md" file 
using "git pull origin main" commad on terminal.
